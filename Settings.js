var organizationSettings = {
    ...
    branchFilter: function(branch) {
        return (
            (branch.buildType.projectName.startsWith("Manage My Documents"))
            || (branch.buildType.projectName.startsWith("Single Sign On"))
			|| (branch.buildType.projectName.startsWith("Tour Itinerary Portal"))
            && (
